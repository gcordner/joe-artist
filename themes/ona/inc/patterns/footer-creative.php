...
return array(
	...
	'content'    => '
			...
			<!-- wp:navigation {"textColor":"background","layout":{"type":"flex","justifyContent":"center","orientation":"horizontal"},"className":"ona-text-letter-spacing","style":{"typography":{"textTransform":"uppercase"}},"fontSize":"tiny"} -->
			...
			<p class="mb-1 ona-copyright has-text-light-color has-text-color has-link-color has-tiny-font-size">' . __( '© 2021 Ona — Made by ' . 'ona' ) . ' <a href="https://deothemes.com">DeoThemes</a></p>
			<!-- /wp:paragraph -->

			<!-- wp:navigation {"textColor":"text-light","className":"ona-sm-down-justify-content-center","style":{"spacing":{"blockGap":"20px"}},"fontSize":"tiny"} -->
