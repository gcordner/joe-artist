...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-group ona-container" style="padding-top:100px;padding-bottom:100px"><!-- wp:columns {"verticalAlignment":"center"} -->
			...
			<div class="wp-block-image"><figure class="aligncenter size-full"><img src="' . esc_url( get_theme_file_uri( 'assets/img/ona_creative_book_mockup.jpg' ) ) . '" alt="" class="wp-image-407"/></figure></div>
			<!-- /wp:image --></div>
			<!-- /wp:column -->
			...
			<!-- wp:group {"className":"ona-newsletter"} -->
			<div class="wp-block-group ona-newsletter"><!-- wp:mailchimp-for-wp/form {"id":409} /--></div>
			<!-- /wp:group --></div>
			<!-- /wp:column -->
