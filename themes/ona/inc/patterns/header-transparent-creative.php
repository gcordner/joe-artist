...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-columns is-not-stacked-on-mobile is-style-no-spacing"><!-- wp:column {"verticalAlignment":"center","width":"20%","className":"ona-sm-down-order-1"} -->
			...
			<div class="wp-block-column is-vertically-aligned-center ona-sm-down-order-2 has-link-color" style="flex-basis:60%"><!-- wp:navigation {"textColor":"background","overlayMenu":"mobile","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal"}} -->
			<!-- wp:navigation-submenu {"label":"Home","url":"/","kind":"custom","isTopLevelItem":true} -->
			<!-- wp:navigation-link {"label":"Main","url":"#","kind":"custom","isTopLevelLink":false} /-->

			<!-- wp:navigation-link {"label":"Minimal (Pro)","url":"#","kind":"custom","isTopLevelLink":false} /-->

			<!-- wp:navigation-link {"label":"Creative (Pro)","url":"#","kind":"custom","isTopLevelLink":false} /-->
			...
			<!-- wp:navigation-link {"label":"About","type":"page","id":223,"url":"#","kind":"post-type","isTopLevelLink":false} /-->

			<!-- wp:navigation-link {"label":"Contact","type":"page","id":224,"url":"#","kind":"post-type","isTopLevelLink":false} /-->
			<!-- /wp:navigation-submenu -->
			<!-- /wp:navigation --></div>
			<!-- /wp:column -->
