...
return array(
	...
	'content'    => '
			...
			<main class="wp-block-group is-style-no-spacing"><!-- wp:cover {"url":"' . esc_url( get_theme_file_uri( 'assets/img/ona_contact_background.jpg' ) ) . '","id":254,"hasParallax":true,"dimRatio":0,"minHeight":85,"minHeightUnit":"vh","contentPosition":"center center","isDark":false} -->
			...
			<div class="wp-block-group has-background-background-color has-background" style="padding-top:80px;padding-right:15%;padding-bottom:80px;padding-left:15%"><!-- wp:image {"align":"center","id":259,"width":246,"height":141,"sizeSlug":"full","linkDestination":"none"} -->
			<div class="wp-block-image"><figure class="aligncenter size-full is-resized"><img src="' . esc_url( get_theme_file_uri( 'assets/img/ona_contact_signature.png' ) ) . '" alt="ona_contact_signature" class="wp-image-259" width="246" height="141"/></figure></div>
			<!-- /wp:image -->
