...
return array(
	...
	'content'    => '
			...
			<!-- wp:navigation {"showSubmenuIcon":false,"className":"ona-text-letter-spacing","style":{"typography":{"textTransform":"uppercase"}},"fontSize":"tiny"} -->
			...
			<!-- wp:column -->
			<div class="wp-block-column"><!-- wp:group {"className":"ona-newsletter"} -->
			<div class="wp-block-group ona-newsletter"><!-- wp:mailchimp-for-wp/form {"id":26} /--></div>
			<!-- /wp:group -->
			...
			<p class="is-style-no-spacing ona-copyright ona-sm-down-text-align-center has-text-light-color has-text-color has-link-color has-tiny-font-size">' . __( '© 2021 Ona, Made by ', 'ona' ) . '<a href="https://deothemes.com">DeoThemes</a></p>
			<!-- /wp:paragraph --></div>
			<!-- /wp:column -->

			<!-- wp:column {"verticalAlignment":"center","width":""} -->
			<div class="wp-block-column is-vertically-aligned-center"><!-- wp:navigation {"textColor":"text-light","layout":{"type":"flex","justifyContent":"right","orientation":"horizontal"},"className":"ona-sm-down-justify-content-center","style":{"spacing":{"blockGap":"20px"}},"fontSize":"tiny"} -->
