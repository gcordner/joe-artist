...
return array(
	...
	'content'    => '
			...
			<div class="wp-block-column is-vertically-aligned-center ona-sm-down-order-2" style="flex-basis:40%"><!-- wp:navigation {"overlayMenu":"mobile","className":"ona-sm-down-justify-content-end"} -->
			...
			<!-- wp:column {"verticalAlignment":"center","width":"20%","className":"ona-sm-down-order-1"} -->
