...
class Merlin {
	...
	private function is_theme_registered() {
		$is_registered = get_option( '_license_key_status', false ) === 'valid';
	...
	protected function content() {
		...
		<div class="merlin__content--transition">
			...
			<?php
				printf( "<img src='%s' alt='" . esc_attr__( 'Home Preview', 'ona' ) . "'class='merlin__image-preview' />", $this->import_files[$demo]['import_preview_image_url'] );
			?>
