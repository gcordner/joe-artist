...
return array(
	...
	<figure class="wp-block-image size-full"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/signature.png" alt="' . esc_attr__( 'Signature', 'bricksy' ) . '" /></figure>
	<!-- /wp:image --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div>
	<!-- /wp:group -->
    ...
    <div class="wp-block-column has-white-background-color has-background has-link-color" style="padding-top:4rem;padding-right:2rem;padding-bottom:4rem;padding-left:2rem"><!-- wp:image {"align":"center","width":214,"height":84,"sizeSlug":"full","linkDestination":"none","className":"emoly-image-spacing"} -->
    <div class="wp-block-image emoly-image-spacing"><figure class="aligncenter size-full is-resized"><img src="' . esc_url( get_template_directory_uri() ) . '/assets/images/signature.png" alt="' . esc_attr__( 'Signature', 'bricksy' ) . '" width="214" height="84"/></figure></div>
    <!-- /wp:image -->
