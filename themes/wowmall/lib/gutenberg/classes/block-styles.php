        ...
        foreach ($aspect_ratio as $ratio) {
            ...
            register_block_style(
                ...
                [
                    ...
                    'inline_style' => ".wp-block-gallery.is-style-{$name} { --wp--custom--preset--aspect-ratio: {$ratio}; }",
                ]
            );
            ...
            register_block_style(
                ...
                [
                    'name'         => $name,
                    'label'        => sprintf(esc_html__('(%s) Aspect Ratio', 'wowmall'), $ratio),
                    'inline_style' => ".wp-block-post-featured-image.is-style-{$name} { --wp--custom--preset--aspect-ratio: {$ratio}; }",
                ]
            );
        }
